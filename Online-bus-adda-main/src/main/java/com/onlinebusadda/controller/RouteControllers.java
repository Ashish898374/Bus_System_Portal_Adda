...
public class RouteControllers {
    ...
    public ResponseEntity<Route> update(@RequestBody Route route,String key) throws RoutesException {

        Route updatedRouteDetails = routes.updateRoute(route, key);
    ...
    public ResponseEntity<List<Route>> viewAllHandler(@RequestParam String key) throws RoutesException{
        List<Route> list = routes.viewallRoute(key);
